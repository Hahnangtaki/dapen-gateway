  ...
  return (
    <div>
      <h2 id="country-my-suffix-heading">
        <Translate contentKey="dapenApp.country.home.title">Countries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="dapenApp.country.home.createLabel">Create new Country</Translate>
        </Link>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
            ...
            <tbody>
              {countryList.map((country, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{country.countryCodeDigits}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dapenApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
